...
Process pweb3 = new ProcessBuilder("python3", "/opt/tomcat/webapps/uploads/createpdf.py", "--arg1", request.getParameter("public"), "--arg2", request.getParameter("private")).start();
